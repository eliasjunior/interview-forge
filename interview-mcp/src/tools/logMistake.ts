...
export function registerLogMistakeTool(server: McpServer, deps: ToolDeps) {
  server.registerTool(
    "log_mistake",
    {
      description: "Record a micro-skill mistake to the mistake log. Captures what went wrong, the pattern (when/why it happens), and the fix. Use this after a drill or interview to preserve a learning.",
      inputSchema: {

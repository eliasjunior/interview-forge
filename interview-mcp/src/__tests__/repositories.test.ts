...
function makeSession(overrides: Partial<Session> = {}): Session {
  return {
    ...
    pendingResponseTimeLimitSec: undefined,
    pendingResponseStartedAt: undefined,
    pendingAnswerElapsedSec: undefined,
...
function normalizeSession(session: Session | null) {
  ...
  return {
    ...
    pendingResponseTimeLimitSec: session.pendingResponseTimeLimitSec,
    pendingResponseStartedAt: session.pendingResponseStartedAt,
    pendingAnswerElapsedSec: session.pendingAnswerElapsedSec,
    activeAdaptiveChallenge: session.activeAdaptiveChallenge,
    ...
    evaluations: session.evaluations.map((evaluation) => ({
      ...
      answerElapsedSec: evaluation.answerElapsedSec,
      responseTimeLimitSec: evaluation.responseTimeLimitSec,
      ...
      adaptiveChallengeType: evaluation.adaptiveChallengeType ?? undefined,
      adaptiveChallengePrompt: evaluation.adaptiveChallengePrompt ?? undefined,
      adaptiveChallengeGoal: evaluation.adaptiveChallengeGoal ?? undefined,
      adaptiveChallengeReward: evaluation.adaptiveChallengeReward ?? undefined,

    ...
    this.db.transaction((tx) => {
      tx.insert(sessions).values(record.session).onConflictDoUpdate({
        ...
        set: {
          ...
          pendingResponseTimeLimitSec: record.session.pendingResponseTimeLimitSec,
          pendingResponseStartedAt: record.session.pendingResponseStartedAt,
          pendingAnswerElapsedSec: record.session.pendingAnswerElapsedSec,

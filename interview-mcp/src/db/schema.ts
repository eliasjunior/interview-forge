...
export const flashcards = sqliteTable("flashcards", {
  ...
  sourceSessionId: text("source_session_id").notNull().references(() => sessions.id, { onDelete: "cascade" }),
  sourceQuestionIndex: integer("source_question_index").notNull(),
  sourceOriginalScore: integer("source_original_score").notNull(),
  title: text("title"),
